<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="text-center mb-6">
            <h2 class="text-lg font-semibold text-gray-700">Buat Akun Gold Prediction</h2>
            <p class="text-xs text-gray-500 mt-1">Silakan isi form berikut untuk melanjutkan.</p>
        </div>
        ...
        <div class="mt-4">
            ...
            <div class="relative">
                ...
                <button type="button" onclick="togglePassword('password', 'togglePasswordIcon1')" 
                    ...
                    <svg id="togglePasswordIcon1" xmlns="http://www.w3.org/2000/svg" 
        ...
        <div class="mt-4">
            ...
            <div class="relative">
                ...
                <button type="button" onclick="togglePassword('password_confirmation', 'togglePasswordIcon2')" 
                        class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-600">
                    <svg id="togglePasswordIcon2" xmlns="http://www.w3.org/2000/svg" 
                        class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        <path d="M10 3C5 3 1.73 7.11 1 10c.73 2.89 4 7 9 7s8.27-4.11 9-7c-.73-2.89-4-7-9-7zm0 12a5 5 0 110-10 5 5 0 010 10zm0-8a3 3 0 100 6 3 3 0 000-6z"/>
                    </svg>
                </button>
        ...
        <div class="mt-4">
         ...
         <div class="mt-4 text-center">
            <p class="text-sm text-gray-600">
                ...
                <a href="{{ route('login') }}" class="text-[#7091F5] hover:underline">{{ __('Masuk') }}</a>
            </p>
        </div>
